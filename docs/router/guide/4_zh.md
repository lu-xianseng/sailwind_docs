...
> [!tip] 如需重新打开当前会话中曾操作过的文件，请点击🖱️会话日志中对应链接。
...
在标准工具栏上点击🖱️**文件 > 打开**菜单项，或点击🖱️主工具栏上的**打开**按钮。
...
1. 点击🖱️**工具 > 选项**菜单项 > **全局**类别 > **备份**子类别

2. 在选项对话框的全局类别备份子类别中，在间隔框中输入⌨️备份间隔时间（分钟）

3. 在备份数量框中输入⌨️要保留的最大备份数量
