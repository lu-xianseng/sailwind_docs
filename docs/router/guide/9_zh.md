...
如果双击一个对象，它会被选中并显示其属性对话框。如果按 Esc 键或右键点击🖱️并选择取消，所有对象将被取消选中。
...
| 扩展对象                               | 按 Shift 键并点击🖱️选择相关对象。例如，如果选中了一个管脚，按 Shift 键并点击🖱️它，则会选中该网络中的所有其他管脚                 |
...
按住 Shift 键并点击🖱️对象会选择该对象及其关联项。选中的对象会变为选项对话框(Options dialog box)中**显示**选项卡(Display tab)为选择项设置的颜色。
