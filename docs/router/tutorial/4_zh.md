...
3. 点击**确定**应用更改并关闭[选项对话框](/logic/guide/24_zh.md#78)
...
2. 选择一个元件。选中元件后，右键点击并选择**特性**。[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)将出现。**替代方法：** 双击元件打开属性对话框

3. 点击**元件**选项卡显示所选元件的属性

4. 要[更改元件属性](/logic/guide/15_zh.md#3-5)如位置、方向和板面，编辑相关框中的数据并点击**应用**

**要求：** [设计规则检查](/layout/guide/19_zh.md#1-6) (DRC) 会阻止元件被放置在非法位置。要关闭检查，输入**DRC**然后按**Enter**。

5. 尝试使用元件属性选项卡更改几个元件的方向或位置

6. 完成后，点击**确定**关闭[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)
...
您也可以使用[项目资源管理器](/layout/guide/2_zh.md#12)选择和移动元件。通过[项目资源管理器](/layout/guide/2_zh.md#12)，您可以快速搜索和定位设计元件，并自动应用如选择、高亮和旋转 90 度等命令。

**放置连接器 J1**

**[放置工具栏](#1)按钮 > 移动按钮**

1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，定位到元件对象
...
1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，滚动浏览元件列表。点击选择**C7**
