...
2. 使用快捷键 gc50 将元件格栅设置为 50 mils。输入**gc**。输入时，命令参数对话框会出现。按**空格键**，输入**50**，然后按**Enter**完成命令

3. 使用快捷键 gd50 将显示格栅设置为 50 mils。输入**gd**。输入时，命令参数对话框会出现。按**空格键**，输入**50**，然后按**Enter**完成命令。在当前视图比例下，您可能看不到显示格栅。如果想查看，只需放大即可
