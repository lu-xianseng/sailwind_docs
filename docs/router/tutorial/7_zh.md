...
2. 点击 **确定** 关闭[选项对话框](/logic/guide/24_zh.md#78)。
...
4. 点击 **确定** 应用更改并关闭[查看网络对话框](/layout/guide/Dialogs/55_zh.md#23)。**结果：** 网络更新后的显示表明平面网络长度未最小化。
...
3. 点击 **确定** 关闭[选项对话框](/logic/guide/24_zh.md#78)并应用更改。
...
2. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，定位到 Components 对象。
...
**[设置布线策略](/layout/guide/33_zh.md#5)：**
...
4. 点击 **确定** 应用更改并关闭[选项对话框](/logic/guide/24_zh.md#78)。

**开始自动布线**

![](/router/tutrial/7/_page_4_Picture_11.jpeg)

您也可以按 F4 开始自动布线。每个自动布线传递完成后，结果会出现在命令窗口的[状态选项卡](/layout/guide/2_zh.md#14)中。

如果命令窗口未打开，请打开它：

在标准工具栏上，点击 **命令窗口** 按钮。

自动布线完成后，命令窗口的[状态选项卡](/layout/guide/2_zh.md#14)中会出现一个指向布线报告的链接。
