...
3. 使用在线[设计规则检查](/layout/guide/19_zh.md#1-6)模式
...
1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，定位 Nets 对象
...
**[结束过孔模式](/layout/guide/32_zh.md#9-3)**
...
**更改[结束过孔模式](/layout/guide/32_zh.md#9-3)：**
...
您可以在布局和布线期间启用实时[设计规则检查](/layout/guide/19_zh.md#1-6)，以确保在整个设计过程中保持设计约束。这种交互式检查称为在线 DRC。您可以通过 DRC Settings 对话框、DRC Filter Toolbar 或使用快捷键设置 DRC 模式。
...
**为禁布区[设置显示颜色](/logic/guide/5_zh.md#2)**
