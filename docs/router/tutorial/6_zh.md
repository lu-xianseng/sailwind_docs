...
在[选项对话框](/logic/guide/24_zh.md#78)的 **全局/常规** 选项卡中或使用 Ctrl+L 快捷键命令打开导线长度监控器。
...
3. 点击 **确定** 接受更改并关闭[选项对话框](/logic/guide/24_zh.md#78)

**创建长度规则**

在使用导线长度监控器之前，必须为网络创建长度规则。在本练习中，您将在[项目资源管理器](/layout/guide/2_zh.md#12)中创建长度规则。

1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，找到网络对象
...
> [!tip] 您可以使用[项目资源管理器](/layout/guide/2_zh.md#12)在设计中找到网络。通过在[项目资源管理器](/layout/guide/2_zh.md#12)的网络分支中选择 CLKIN 网络来找到它。
...
最小蛇形线间隙和幅度设置在[选项对话框](/logic/guide/24_zh.md#78)的布线/调整选项卡中定义。
...
4. 点击 **确定** 接受设置并关闭[选项对话框](/logic/guide/24_zh.md#78)。
...
1. 在[项目资源管理器](/layout/guide/2_zh.md#12)的网络分支中选择 **CLKIN** 网络。在设计区域右键点击并选择"取消布线"。这将取消布线之前在本教程中创建的长度限制网络
...
> [!tip] 定义手动蛇形线不会影响[选项对话框](/logic/guide/24_zh.md#78)布线选项卡中分配的默认蛇形线。下次使用"添加蛇形线"时，将应用默认值。练习添加自定义蛇形线并尝试在蛇形线的不同位置设置不同的幅度。
...
**[创建差分对](/logic/guide/16_zh.md#12)**

1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，展开网络对象树
...
3. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，选择网络列表中的一个网络（**\$\$\$7651** 或 **\$\$\$7652**）。**结果：** 网络在工作区中高亮显示
...
1. 使用[项目资源管理器](/layout/guide/2_zh.md#12)，选择您在上一个示例中创建的 **\$\$\$7651<->\$\$\$7652** 差分对
...
您可以在[项目资源管理器](/layout/guide/2_zh.md#12)中创建或修改设计对象。在本练习中，您将在[项目资源管理器](/layout/guide/2_zh.md#12)中[创建匹配长度网络组](/router/guide/11_zh.md#25)规则。
...
> [!tip] 如果[项目资源管理器](/layout/guide/2_zh.md#12)中看不到匹配长度网络组分支，将选择项拖到[项目资源管理器](/layout/guide/2_zh.md#12)的顶部，强制列表滚动。这允许您将选择项放到匹配长度网络组分支中
...
1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，展开组件分支显示设计中的所有组件
...
4. 点击 **确定** 关闭[选项对话框](/logic/guide/24_zh.md#78)
...
3. 在[项目资源管理器](/layout/guide/2_zh.md#12)中，展开网络对象树
