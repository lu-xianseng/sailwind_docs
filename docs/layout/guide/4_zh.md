...
阅读以下主题了解 `SailWind Layout` 中的设计与[编辑基础知识](/logic/guide/9_zh.md#2-1)。
...
印刷电路板的布局显示重叠的对象层和每层上密集的设计对象区域，使得难以选择所需的对象。[使用选择筛选条件](/logic/guide/9_zh.md#6)可以帮助解决此问题。

[使用选择筛选条件](/logic/guide/9_zh.md#6)可以指定对象类型甚至选择对象的层。[选择筛选条件](#2)有两个选项卡：对象和层。作为快捷方式，您还可以使用快捷菜单上提供的预设[选择筛选条件](#2)设置。

有三种[使用选择筛选条件](/logic/guide/9_zh.md#6)的方法。更多信息请参阅本节中的主题。

### 使用选择筛选条件快捷方式过滤选择 \{#2-1}

[使用选择筛选条件](/logic/guide/9_zh.md#6)快捷方式可以快速设置[选择筛选条件](#2)以选择设计中的项目。
...
2. **右键**单击并单击其中一个[选择筛选条件](#2)预设。

👀‍**结果**

在[选择筛选条件对话框](/logic/guide/24_zh.md#125)中，根据您选择的预设选中相应的复选框。

### 在选择筛选条件中按对象类型过滤选择 \{#2-2}

[使用选择筛选条件](/logic/guide/9_zh.md#6)的**对象**选项卡指定您希望在设计中能够选择的对象类型。

1. 单击**编辑>筛选条件**菜单项。

2. 在[选择筛选条件对话框](/logic/guide/24_zh.md#125)中，在对象选项卡上，通过选择适当的对象类型复选框来选择设计和绘图项目。
...
[使用选择筛选条件](/logic/guide/9_zh.md#6)的**层**选项卡指定您希望在设计中能够选择对象的层。

🏃‍♂️‍**步骤**

1. 单击**编辑>筛选条件**菜单项。

2. 在[选择筛选条件对话框](/logic/guide/24_zh.md#125)中，在层选项卡上，通过选择适当的层复选框从层列表中选择层。
...
要[选择多个对象](/logic/guide/9_zh.md#3-2)，按住 Ctrl 键同时依次单击每个项目。或者，您可以拖动选择区域围绕多个对象，根据您在[选择筛选条件](#2)中的设置，选择区域内的所有内容都将被选中。
...
如果您尝试在密集或拥挤的区域中选择对象，请[使用选择筛选条件](/logic/guide/9_zh.md#6)禁用其他项目进行选择或使用循环命令。有关说明，请参阅"循环拾取"。或者，您可以进行区域选择，然后**右键**单击选择**选择列表**菜单项。详情请参阅"[通过选择列表选择对象](#5)"。
...
> [!tip] [选项对话框](/logic/guide/24_zh.md#78)**全局>常规**选项卡中的"拖动移动"区域可能会影响您在密集设计中进行区域选择的能力。如果选中的对象在您进行区域选择时开始移动，请从快捷菜单中单击**取消**并尝试从不同区域开始。要禁用拖动移动，请将拖动移动设置设置为"无拖动移动"。
...
| 从选中的网络[选择电气网络](/layout/guide/16_zh.md#7)        | **右键**单击并单击[选择电气网络](/layout/guide/16_zh.md#7)弹出菜单项。                                          |
...
3. 单击新打开工具栏上的一个按钮。命令附加到鼠标，状态栏显示命令名称。现在您可以将命令应用于您选择的对象。当您将鼠标移动到工作区时，鼠标上会出现一个小 V，显示所选命令处于活动状态 - 鼠标处于动词模式。

4. 选择要执行活动命令的对象。对象是设计中的一个独立项目，例如走线段或元件。单击**选择**按钮取消命令。某些命令适用于区域选择(多个项目)。例如，移动命令或总线布线命令。

**示例**

在设计工具栏上，单击**旋转**按钮。小 V 附加到工作区内的鼠标上。选择一个元件。元件处于旋转模式。指示新方向或按 Esc 键取消旋转。
...
3. 您可以继续单击**循环**按钮，在当前鼠标位置的所有对象之间循环选择。
...
2. **右键**单击并单击**[选择缝合过孔](/layout/guide/32_zh.md#15-22-2)**弹出菜单项。
...
1. 单击**编辑>查找**菜单项。[查找对话框](/layout/guide/Dialogs/49_zh.md#15)打开。
...
- **[剪切、复制和粘贴](/logic/guide/10_zh.md#12)支持属性** 当您剪切、复制或粘贴对象时，它们的属性也随之[剪切、复制和粘贴](/logic/guide/10_zh.md#12)。属性标签也随其分配的对象一起[剪切、复制和粘贴](/logic/guide/10_zh.md#12)。

- **[剪切、复制和粘贴](/logic/guide/10_zh.md#12)也支持物理设计重用** 您一次只能复制一个物理设计重用。当您复制一个物理设计重用并将其粘贴到不同的设计中时，将重用文件与当前设计进行比较以检测可能的参考标识符、层、封装和网络名称冲突。此比较还将检测其他错误和警告，如"添加物理设计重用的过程"中所述。

- **[剪切、复制和粘贴](/logic/guide/10_zh.md#12)组** 当您粘贴一个组时，可能会在其中一个[走线复制对话框](/layout/guide/Dialogs/55_zh.md#7)中出现错误。更多信息请参阅"[走线复制对话框](/layout/guide/Dialogs/55_zh.md#7)"主题。组编辑选项也会影响这一点。

- **粘贴** 您只能在 `DRC` 关闭模式下粘贴项目。

- **仅复制走线、走线和过孔或仅布线管脚对** 当您选择并复制走线或走线和过孔组合时，您开始一个专门的操作，立即将所选布线的副本附加到鼠标，并允许您通过鼠标单击重复粘贴。此功能绕过粘贴命令，自动将设计对象添加到鼠标，并允许您在启用[设计规则检查](/layout/guide/19_zh.md#1-6)的情况下粘贴。
