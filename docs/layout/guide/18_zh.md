...
1. 点击👆**编辑 > 属性管理器**
2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)的查看区域点击👆视图选项：
   - **已选定** 列出设计中选定对象的属性
...
4. 在属性列表中选择👉属性名称旁边的复选框
   ...
   > [!tip] 可以使用**全选**或**取消全选**按钮选择👉或清除所有复选框。
...
2. 在[属性管理器对话框](/layout/guide/Dialogs/46_zh.md#44)中选择👉包含`<none>`的单元格
