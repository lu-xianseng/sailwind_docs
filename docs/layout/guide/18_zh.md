...
2. 如果要编辑用于旧版文件的默认属性，点击🖱️**主页>导入**并导入文件 *Default.asc* 或*DefaultAttributeDictionary.asc*
...
6. 要覆盖现有文件，点击🖱️**主页>导出**。执行此操作可更改 *default.asc* 或*DefaultAttributeDictionary.asc* 文件。如果要创建仅用于新文件的启动文件，请转至步骤 10
