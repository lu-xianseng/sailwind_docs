...
8. 在管脚选项卡上，您必须填写管脚组和名称列；其他列是可选的。有关说明，请参见"编辑管脚表数据"。

9. 在属性选项卡上，根据需要添加属性。有关说明，请参见第 243 页的"为元件类型添加属性"。
...
7. 在 PCB 封装选项卡上，为元件分配一个或多个数字封装。有关说明，请参见"将字母数字管脚编号映射到数字封装"。

8. 在门选项卡上，添加至少一个门。（如果要能够交换它们，请添加多个门。）有关说明，请参见"为门分配 CAE 封装"。
...
10. 在属性选项卡上，根据需要添加属性。有关说明，请参见第 243 页的"为元件类型添加属性"。

11. 在管脚映射选项卡上，将未映射的逻辑管脚（字母数字）映射到物理封装管脚（数字）。有关说明，请参见"将字母数字管脚编号映射到数字封装"。
...
6. 在 PCB 封装选项卡上，为元件分配一个或多个封装。有关说明，请参见"将字母数字管脚编号映射到数字封装"。

7. 在门选项卡上，添加至少一个门。（如果要能够交换它们，请添加多个门。）有关说明，请参见"为门分配 CAE 封装"。
...
6. 在 PCB 封装选项卡上，为元件分配一个非电气（无管脚端子）封装。有关说明，请参见"将字母数字管脚编号映射到数字封装"。

7. 在属性选项卡上，根据需要添加属性。有关说明，请参见第 243 页的"为元件类型添加属性"。
...
7. 在 PCB 封装选项卡上，为元件分配一个或多个封装。有关说明，请参见"将字母数字管脚编号映射到数字封装"。

8. 在管脚选项卡上，您必须填写管脚组和名称列；其他列是可选的。有关说明，请参见"编辑管脚表数据"。

9. 在属性选项卡上，根据需要添加属性。有关说明，请参见第 243 页的"为元件类型添加属性"。

10. 在连接器选项卡上，添加要在原理图中使用的管脚封装。有关说明，请参见"为连接器分配特殊符号"。
