...
| 名称                  | 命令       | 描述                                                                                                                                                                                                          |
|-----------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 全局格栅设置          | G`<x>` {`<y>`} | 同时设置设计和过孔格栅。第二个参数可选。如果输入一个参数，则对`<x>`和`<y>`应用相同值。例如：G 25, G 8.3 或 G 16-2/3, G 5 25                                                                                        |
| 显示(点)格栅设置      | GD `<x>` {`<y>`} | 设置显示(点)格栅。第二个参数可选。如果输入一个参数，则对`<x>`和`<y>`应用相同值。例如：GD 8-1/3, GD 25 25, 或 GD 100                                                                                              |
| 设计格栅设置          | GR `<x>` {`<y>`} | 设置设计格栅(放置和布线)。第二个参数可选。如果输入一个参数，则对`<x>`和`<y>`应用相同值。例如：GR 8-1/3, GR 25 25, GR 25                                                                                           |
| 过孔格栅设置      | GV `<x>` {`<y>`} | 设置过孔格栅。第二个参数可选。如果输入一个参数，则对`<x>`和`<y>`应用相同值。例如：GV 8-1/3, GV 25 25, 或 GV 100                                                               |
