...
您可以通过键入⌨️命令代码字母、输入⌨️新值并按 Enter 键随时设置或更改某些设置和功能。这称为*无模命令*。

无模命令通常适用于设计过程中经常更改的值。例如，使用无模命令"G"更改格栅设置。键入⌨️"G"、新设置，然后按 Enter 键。

在 SailWind Layout 运行时，随时键入⌨️"?"并按 Enter 键可显示此帮助主题。
...
| 约定              | 描述                                                                         |
|-------------------|-----------------------------------------------------------------------------|
| `<value>`          | 变量或可输入⌨️内容(仅限无模命令)                                               |
| { }              | 可选命令参数                                                                |
| `<Click>`          | 点击🖱️鼠标左键                                                                |
| MButton+`<Click>`  | 点击🖱️鼠标中键或滚轮                                                          |
| RButton+`<Click>`  | 点击🖱️鼠标右键                                                                |
...
| 名称                  | 命令       | 描述                                                                                                                                                                                                          |
|-----------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 全局格栅设置          | G`<x>` {`<y>`} | 同时设置设计和过孔格栅。第二个参数可选。如果输入⌨️一个参数，则对`<x>`和`<y>`应用相同值。例如：G 25, G 8.3 或 G 16-2/3, G 5 25                                                                                        |
| 显示(点)格栅设置      | GD `<x>` {`<y>`} | 设置显示(点)格栅。第二个参数可选。如果输入⌨️一个参数，则对`<x>`和`<y>`应用相同值。例如：GD 8-1/3, GD 25 25, 或 GD 100                                                                                              |
| 设计格栅设置          | GR `<x>` {`<y>`} | 设置设计格栅(放置和布线)。第二个参数可选。如果输入⌨️一个参数，则对`<x>`和`<y>`应用相同值。例如：GR 8-1/3, GR 25 25, GR 25                                                                                           |
| 过孔格栅设置      | GV `<x>` {`<y>`} | 设置过孔格栅。第二个参数可选。如果输入⌨️一个参数，则对`<x>`和`<y>`应用相同值。例如：GV 8-1/3, GV 25 25, 或 GV 100                                                               |
...
| 将当前宽度更改为`<n>`         | W `<n>`   | 将当前走线或线宽更改为输入⌨️的数字`<n>`，例如 W 5。                                                                                                                                                                                                                                                                                                                             |
...
| 搜索并选择                                          | SS `<s>`  | 按参考标志符搜索并选择元件，例如 SS U10。您还可以通过输入⌨️多个条目搜索并选择多个元件，例如 SS U10 U5 R6。                                                                                                                                                                                      |
|                                                      |         | 提示在无模命令中空格可能很重要。例如，SS W1 和 S SW1 具有不同含义。SS W1 告诉 SailWind Layout 搜索并选择 W1，而 S SW1 告诉它搜索 SW1。                                                                                                                                                           |
| 使用星号*搜索并选择                                 | SS `<s>`* | 您可以使用星号*进行搜索和选择。键入⌨️ SS、空格、要搜索的字符和星号。例如，要搜索并选择所有以 C 开头的元件，键入⌨️ SS C*。所有参考标志符以 C 开头的元件将被选中✅。                                                                                                                                    |
...
|                    |      | • P — 管脚或过孔原点。                                                                                                                                                                                   |
|                    |      | • Q — 象限；圆或圆弧上的四个正交点。                                                                                                                                                                      |
|                    |      | 例如：如果只想捕捉中点，键入⌨️ OS M。或者如果想捕捉所有对象，键入⌨️ OS CEIMOPQ。                                                                                                                               |
...
| 互补格式 | C    | 键入⌨️ C 并按 Enter 键将显示更改为互补格式，可查看平面层上的热焊盘和反焊盘。键入⌨️C 第二次并按 Enter 键可恢复正常的非互补视图。 |
...
| 仅查看您输入⌨️的范围层                                           | Z `<n-m>`                      | 仅查看您输入⌨️的范围层。例如，Z 2-4 显示层 2、3 和 4。不要用方括号括起范围。                                                                                                                                                                                                                                                                           |
| 仅查看您输入⌨️的层                                               | Z `<layer n>` {`<layerm>` …} | 仅查看您输入⌨️的层。例如，Z 2 4 d 显示层 2、4 和文档层。                                                                                                                                                                                                                                                                                              |
...
|                                                                                |        | 提示键入⌨️ ZR 并按 Enter 键可查看此会话中由 ZS 创建的所有层配置列表。另请参阅：ZS。                                                                                                                                                             |
...
| 使用通孔过孔            | VT `<name>` | 在[过孔对话框](/layout/guide/Dialogs/55_zh.md#21)中将过孔模式设置为通孔。如果存在多个过孔，您还可以键入⌨️要使用的过孔名称。详见对话框主题获取更多信息。 |
|      |      | 键入⌨️要使用的过孔名称。详见对话框主题获取更多信息。                          |
...
| 名称          | 命令 | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|---------------|------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 快速测量      | Q    | 使用动态标尺快速测量。将光标放在起点，然后键入⌨️"q"无模命令。拖动光标在测量起点和终点之间创建一条线。当捕捉到格栅开启时，捕捉到设计格栅。当格栅捕捉关闭时，测量无格栅。动态报告当前设计单位中的 delta x、delta y 和 delta x,y。您还可以使用此命令测量极坐标格栅节点之间的精确欧几里得距离。                                                                                                                                                                                                                                 |
|               |      | 快速测量模式也适用于对象捕捉。但除非您在对象类型的捕捉半径内，否则不会给您选择捕捉到格栅或对象作为起点的选项。捕捉到对象类型优先于捕捉到格栅。                                                                                                                                                                                                                                                                                                                                                                                       |
|               |      | 您可以在测量操作期间的弹出菜单、选项对话框或使用 OS 无模命令启用捕捉到对象。                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|               |      | 另请参阅："测量"。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 快速长度      | QL   | 快速长度。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|               |      | 1. 区域选择要测量的布线项目；如走线段、网络或管脚对。                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|               |      | 2. 键入⌨️ QL 并按 Enter 键。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| 名称                                                     | 快捷键 | 描述                                                                                                                  |
|----------------------------------------------------------|--------|----------------------------------------------------------------------------------------------------------------------|
| 激活右键弹出菜单(右键鼠标按钮)                       | M      | 激活当前模式的快捷菜单。与**右键**点击🖱️相同。                                                                          |
| 左键点击🖱️                                                 | `<Spacebar>`    | 在当前鼠标位置激活左键鼠标按钮点击🖱️(添加拐角、选择项目、完成等)。                                              |
