...
| 名称                          | 命令 | 描述                                                                                                                   |
|-------------------------------|------|-----------------------------------------------------------------------------------------------------------------------|
| 设置设计单位为英寸            | UI   | 在[选项对话框](/logic/guide/24_zh.md#78)的全局类别>`常规子类别中将设计单位设置为英寸                                                               |
| 设置设计单位为密耳            | UM   | 在[选项对话框](/logic/guide/24_zh.md#78)的全局类别>`常规子类别中将设计单位设置为密耳(千分之一英寸)                                                 |
| 设置设计单位为毫米(公制)      | UMM  | 在[选项对话框](/logic/guide/24_zh.md#78)的全局类别>`常规子类别中将设计单位设置为公制(毫米)                                                         |
...
| 活动层前置开/关   | D    | 在[选项对话框](/logic/guide/24_zh.md#78)的全局类别>`常规子类别中切换活动层设置。         |
...
| 名称                                                 | 命令 | 描述                                                                                                                                                                                                                                              |
|------------------------------------------------------|------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 逐个高亮网络                                         | N `<s>`   | 逐个高亮网络。要将高亮网络`<s>`置于堆栈顶部，重复该命令，例如 N GND。提示高亮网络采用[显示颜色对话框](/logic/guide/24_zh.md#49)中指定的高亮颜色。                                                                                                                 |
...
|               |      | 您可以在测量操作期间的弹出菜单、[选项对话框](/logic/guide/24_zh.md#78)或使用 OS 无模命令启用捕捉到对象。                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|               |      | 另请参阅："测量"。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 快速长度      | QL   | 快速长度。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|                           | 命令 | 描述                                                                                                                                                                                                                                                                                                                                                                                                     |
|---------------------------|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 基本日志测试              | BLT  | 基本日志测试。打开[日志测试对话框](/layout/guide/Dialogs/51_zh.md#9)。BLT 查找并运行 BMW 会话回放媒体。另请参阅：[BMW 和 BLT](/logic/guide/23_zh.md#2)                                                                                                                                                                                                                                                                                                                    |
| 打开基本媒体向导          | BMW  | 打开基本[媒体向导对话框](/layout/guide/Dialogs/51_zh.md#19)。• BMW 为有问题的 `SailWind Logic`、`SailWind Layout` 或 `SailWind Router` 会话记录会话回放媒体。它可以基于您上次 SailWind 会话或当前会话创建回放媒体。此回放媒体可以使用 BLT 无模命令回放。• BMW 也是命令行选项。另请参阅：[BMW 和 BLT](/logic/guide/23_zh.md#2)                                                                                                                                                   |
...
|                                                    | Ctrl+Q        |                                                                          |
| 全局选项                                           | Ctrl+`<Enter>`  | 打开[选项对话框](/logic/guide/24_zh.md#78)。                                                        |
| 显示颜色设置                                       | Ctrl+Alt+C    | 打开[显示颜色设置对话框](/layout/guide/Dialogs/48_zh.md#31)。                                                |
| 选项>`设计类别                                  | Ctrl+Alt+D    | 打开[选项对话框](/logic/guide/24_zh.md#78)的设计类别。                                              |
| 选项>`全局类别>`常规子类别                       | Ctrl+Alt+G    | 打开[选项对话框](/logic/guide/24_zh.md#78)的全局类别>`常规子类别。                               |
...
| 添加过孔                              | Shift+LButton+`<Click>` | 添加过孔([交互式布线](/router/guide/19_zh.md#4))。                                                                                                                                                                        |
| 添加跳线                              | Ctrl+Alt+J            | 添加跳线([交互式布线](/router/guide/19_zh.md#4))。                                                                                                                                                                     |
| 回退                                  | `<Backspace>`           | 移除走线上的最后一个转角或 2D 线上的最后一个转角(在多边形或路径绘制模式中)。                                                                                                             |
| 拉伸                                  | Shift+S               | 拉伸([交互式布线](/router/guide/19_zh.md#4)模式)。                                                                                                                                                                     |
| 完成布线                          | `<Enter>`               | 完成布线。                                                                                                                                                                                    |
| 完成                                  | LButton+`<Click>`       | 完成([交互式布线](/router/guide/19_zh.md#4))当鼠标靠近有效                                                                                                                                                             |
|                                       | LButton+`<DoubleClick>` | 完成点时。                                                                                                                                                                                    |
| 结束(布线)                            | Ctrl+LButton+ `<Click>` | 结束([交互式布线](/router/guide/19_zh.md#4))。                                                                                                                                                                            |
