...
设计准备包括建立层叠结构、[设置显示颜色](/logic/guide/5_zh.md#2)、定义板框边框以及其他相关操作。

**本课程内容：**

- [为 PCB 建立层叠结构](#1)
- [设置显示颜色](/logic/guide/5_zh.md#2)
- [保存启动文件](#2)
- [创建板框边框](#3)
- [修改板框边框](#4)
- [添加非电气对象](#5)
...
下一个过程通过将现有直线之一更改为圆弧来[修改板框边框](#4)的一部分。在[修改板框边框](#4)之前，必须调整[选择过滤器](/logic/tutorial/2_zh.md#4-1)以定义可选择的对象类型。
