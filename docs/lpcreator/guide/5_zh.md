...
1. 选择以下之一：
    ...
    - 使用库编辑器中的多元件向导：
        ...
        iii. 然后右键点击并点击**工具 > 向导**弹出菜单项或从菜单栏点击启动"[多元件向导对话框](/lpcreator/guide/4_zh.md#9)"。
...
1. 选择以下之一：
	...
	- 使用库编辑器中的多元件向导：
		...
		iii. 然后右键点击并点击**工具 > 向导**弹出菜单项或从菜单栏点击**工具 > 向导**启动"[多元件向导对话框](/lpcreator/guide/4_zh.md#9)"。
...
10. 在"[保存元件类型](/logic/guide/7_zh.md#8-12)和封装到库"对话框中，为元件类型和封装都点击**全选**。
