...
[属性.应用属性](#page-45-0) [属性.名称属性](#page-46-0) [属性.父级属性](#page-48-0) [属性.值](#page-49-0) 属性 [属性.测量方法](#page-51-0)
...
如果内部解析器无法识别属性中的测量值，它会创建一个虚拟的[应用.测量](#page-21-0) [方法](#page-21-0)对象，其[测量.值](#page-179-0) 属性属性等于0.0，[测量.文本](#page-176-0) 属性属性等于[属性.值](#page-49-0) 属性属性。
...
[组件.应用属性](#page-53-0) [组件.属性属性](#page-54-0) [组件.门属性](#page-55-0) [组件.名称属性](#page-56-0) [组件.对象类型](#page-58-0) 属性 [组件.父级属性](#page-60-0) [组件.部件类型](#page-61-0) 属性 [组件.部件类型逻辑](#page-62-0) 属性 [组件.部件类型对象](#page-63-0) 属性 [组件.PCB封装属性](#page-64-0) [组件.引脚属性](#page-65-0) [组件.选中属性](#page-68-0) [组件.未使用门属性](#page-69-0) [组件.删除方法](#page-70-0)
...
以下示例代码使用[属性.计数属性](#page-36-0)属性检索组件 U1 的属性数量，假设它存在于打开的原理图中。有关运行此示例的更多信息，请参阅第21页的"代码示例"。
...
[Field.Application 属性](#page-119-0) [Field.Name 属性](#page-120-0) [Field.Parent 属性](#page-121-0) [Field.Value](#page-122-0) 属性
...
[Fields.Application 属性](#page-124-0) [Fields.Count 属性](#page-125-0) [Fields.Item 属性](#page-126-0) [Fields.Parent 属性](#page-127-0) [Fields.Add 方法](#page-128-0) [Fields.Delete 方法](#page-129-0)
...
[Gate.Application 属性](#page-131-0) [Gate.Component 属性](#page-132-0) [Gate.Name 属性](#page-133-0) [Gate.Number 属性](#page-135-0) [Gate.ObjectType](#page-136-0) 属性 [Gate.Parent 属性](#page-138-0) [Gate.Pins 属性](#page-139-0) [Gate.PositionX 属性](#page-140-0) [Gate.PositionY 属性](#page-141-0) [Gate.ReflectedX 属性](#page-142-0) [Gate.ReflectedY 属性](#page-143-0) [Gate.Rotated90 属性](#page-144-0) [Gate.Selected 属性](#page-145-0) [Gate.Sheet 属性](#page-146-0) [Gate.SwapClass 属性](#page-147-0) [Gate.Visibility](#page-148-0) 属性 [Gate.Delete 方法](#page-150-0) [Gate.Move 方法](#page-151-0)
...
以下列表标识了 LibraryItem 的属性：

[LibraryItem.Application 属性](#page-153-0) [LibraryItem.Library 属性](#page-154-0) [LibraryItem.Name 属性](#page-155-0) [LibraryItem.ObjectType](#page-156-0) 属性 [LibraryItem.Parent 属性](#page-157-0) [LibraryItem.Type](#page-158-0) 属性
...
Library 对象表示库列表中包含的库。以下列表标识了 Library 的属性和方法：

> [Library.Application](#page-161-0) 属性 [Library.FullName](#page-162-0) 属性 [Library.Name](#page-163-0) 属性 [Library.ObjectType](#page-164-0) 属性 [Library.Parent](#page-165-0) 属性 [Library.Path](#page-166-0) 属性 [Library.GetLibraryItems](#page-167-0) 方法 [Library.ImportLibraryItems](#page-168-0) 方法 [Library.ImportLibraryItems2](#page-169-0) 方法
...
[Measure.Application 属性](#page-171-0) [Measure.Name 属性](#page-172-0) [Measure.Number 属性](#page-173-0) [Measure.Parent 属性](#page-174-0) [Measure.Prefix 属性](#page-175-0) [Measure.Text](#page-176-0) 属性 [Measure.Unit 属性](#page-178-0) [Measure.Value](#page-179-0) 属性 [Measure.Normalize 方法](#page-182-0)
...
[Net.Application 属性](#page-184-0) [Net.Attributes 属性](#page-185-0) [Net.Name 属性](#page-186-0) [Net.ObjectType](#page-188-0) 属性 [Net.Parent 属性](#page-190-0) [Net.Pins 属性](#page-191-0) [Net.Selected 属性](#page-192-0) [Net.Width 属性](#page-193-0)
...
PartType 对象表示打开的原理图中存在的物理部件的部件类型（封装）。以下列表标识了 PartType 属性：

[PartType.Application](#page-210-0) 属性 [PartType.Components](#page-211-0) 属性 [PartType.ECORegistered](#page-212-0) 属性 [PartType.Logic](#page-213-0) 属性 [PartType.Name](#page-214-0) 属性 [PartType.ObjectType](#page-217-0) 属性 [PartType.Parent](#page-219-0) 属性 [PartType.Selected](#page-220-0) 属性
...
[Sheet.Application 属性](#page-241-0) [Sheet.ChildSheets 属性](#page-242-0) [Sheet.Components 属性](#page-243-0) [Sheet.Gates 属性](#page-245-0) [Sheet.Name 属性](#page-246-0) [Sheet.Nets 属性](#page-247-0) [Sheet.Parent 属性](#page-249-0) [Sheet.ParentSheet 属性](#page-250-0) [Sheet.PartTypes](#page-251-0) 属性 [Sheet.Pins 属性](#page-252-0) [Sheet.Activate 方法](#page-253-0) [Sheet.AddComponent 方法](#page-254-0) [Sheet.AddGate 方法](#page-256-0) [Sheet.GetObjects 方法](#page-258-0)
