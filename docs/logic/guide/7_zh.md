...
您可以通过单击工具 > 元件编辑器菜单项，或单击[库管理器对话框](/layout/guide/Dialogs/51_zh.md#8)中的编辑按钮来访问元件编辑器。
...
您可以使用预设筛选条件设置来控制对象选择，也可以使用“[选择筛选条件](/layout/guide/4_zh.md#2)”对话框。
...
您可以使用“[选择筛选条件](/layout/guide/4_zh.md#2)”对话框控制可选择的对象。这可以快速选择元件、门、网络、管脚、总线、连接、2D 线、文本和其他设计对象。
...
出现“[选择筛选条件](/layout/guide/4_zh.md#2)”对话框。
...
2. 在“选择编辑项类型”对话框中，单击“[CAE 封装](#7)”，然后单击“确定”。弹出“从库中获取门封装”对话框。
3. 在项目框中，键入上的通配符或表达式来过滤符号，然后单击应用。
4. 单击“添加”。您将进入“封装编辑器”，并显示封装。
5. 根据需要修改封装。
6. 单击“文件 > 另存为菜单项。将显示“将 [CAE 封装](#7)保存到库中”对话框。
...
7. 要过滤封装，请在筛选条件框中键入上的通配符或表达式，然后单击应用。
...
3. 在“选择编辑项目的类型”对话框中，单击“[CAE 封装](#7)”，然后单击“确定”。现在，您已进入封装编辑器，可以[创建新的 CAE 封装](#7-4)。
4. 单击“封装编辑工具栏”按钮。
5. 单击 [CAE 封装](#7)向导按钮。
...
7. 单击“创建 2D 线”按钮，然后构建封装主体。有关更多信息，请参阅“[创建 2D 线项目](/logic/guide/12_zh.md#1)”主题。
...
2. 在元件编辑器中，单击编辑 > [CAE 封装](#7)编辑器菜单项，或在元件编辑器工具栏上单击编辑图形按钮。
...
7. 为元件分配电气信息。
   ...
   a. 在元件编辑器工具栏上，单击“编辑电参数”按钮。将显示上的“元件信息”对话框。

   b. 设置管脚数以指示元件中的管脚总数。如果元件中存在在上述步骤中[创建 CAE 封装](/logic/tutorial/3_zh.md#2)时未添加的信号管脚，则必须设置此管脚数。

   （可选）单击“PCB 封装”选项卡以[分配 PCB 封装](#8-4)。分配的 PCB 封装的管脚数必须等于或大于电气描述。
...
3. 请参阅下表，了解根据所选对象可用的编辑选项。
   ...
   | 选定对象 | 可用的菜单命令 |
   | --- | --- |
   | 起草项目 | 查询/修改、移动、复制和删除。[选择多个对象](/logic/guide/9_zh.md#3-2)时，可以使用“分解”和“合并”。（参见“[修改绘图对象](/layout/guide/27_zh.md#14)”） |
   | 标签 | 移动 |
...
1. 在封装编辑工具栏上，单击“[设置管脚类型](#7-11)”按钮。此时将显示“管脚类型”信息窗口。
...
1. 选择要应用管脚类型信息的封装管脚。
2. 在封装编辑工具栏上，单击“[设置管脚类型](#7-11)”按钮。此时将显示“管脚类型”信息窗口。
...
2. 使用以下方法之一定义属性标签：
   ...
   - 选择“[浏览属性库](#8-9)”以打开“[浏览属性库](#8-9)”对话框，从列表中选择一个属性名称，然后单击“确定”。

3. （可选）设置文本大小、宽度或对齐方式。
4. 单击“确定”。另请参阅“[设置显示颜色](/logic/guide/5_zh.md#2)”。
...
1. 在封装编辑器中打开 [CAE 封装](#7)，然后单击“设置 > 设置原点菜单项。
...
1. 在元件编辑器中，单击“打开”按钮。
2. 在“选择编辑项目的类型”对话框中，单击“[CAE 封装](#7)”，然后单击“确定”。
3. 在项目框中键入上的通配符或表达式来过滤符号，然后单击应用。
4. 从封装区域中选择元件。
5. 单击“确定”。所选封装将显示。
...
3. 单击“封装编辑工具栏”按钮以显示封装编辑工具栏，然后单击“[设置管脚编号](#7-9)”按钮。
...
3. 或者，如果您想添加、删除和[编辑逻辑系列](#8-3)和默认参考指示器前缀，请单击“系列”。
...
1. 在元件编辑器中，单击编辑电参数按钮，然后在元件的[元件信息对话框](/logic/guide/24_zh.md#85)中，单击常规选项卡。
...
1. 在元件编辑器中，打开 > 元件类型，然后单击“编辑电参数”按钮。
2. 在“元件信息”对话框中，单击“常规”选项卡，然后单击“系列”按钮。
3. 在[逻辑系列对话框](/layout/guide/Dialogs/51_zh.md#10)中，从列表中选择逻辑系列。
...
1. 在元件编辑器中，打开 > 元件类型，然后单击“编辑电参数”按钮。
2. 在“元件信息”对话框中，单击“常规”选项卡，然后单击“系列”按钮。
3. 在[逻辑系列对话框](/layout/guide/Dialogs/51_zh.md#10)中，从列表中选择要删除的逻辑系列。
4. 单击“删除”按钮。
5. 单击“确定”。
...
2. 在元件编辑器的工具栏上，单击“编辑电参数”按钮，然后在[元件信息对话框](/logic/guide/24_zh.md#85)中，单击“PCB 封装”选项卡。
...
4. 要为门定义逻辑封装，请选择“[CAE 封装](#7) 1”下的单元格，单击“编辑”，然后在“[CAE 封装](#7)”框中键入封装名称，或单击“浏览”按钮从库中搜索封装。
...
5. 要限制“未分配的封装”列表框中显示的项目，请在筛选条件框中键入上的通配符或表达式，然后单击“应用”。
...
2. 在[元件信息对话框](/logic/guide/24_zh.md#85)的管脚选项卡上，单击添加管脚按钮。
...
7. 单击“序列 (Seq.)”单元格并输入门序列号。序列号决定了 CAE 门管脚到 PCB 封装管脚的映射。该序列会自动与备用 [CAE 封装](#7)共享。例如，序列号显示了管脚号在 CAE 门封装上的显示方式；因此，在门 A 中，序列号 1 可能是管脚 1，但在门 B 中，序列号 1 可能是管脚 4。
...
1. 打开 > 元件类型，在工具栏上单击“编辑电参数”按钮，然后单击“元件信息”对话框中的“管脚”选项卡。
2. 在“数字”列中选择一个或多个单元格。
3. 单击“重新编号”按钮。在“[重新编号管脚](#8-7-6)”对话框中，“管脚数”框将显示选定要重新编号的管脚数。
4. 在“起始管脚号”区域的“前缀”和/或“后缀”框中输入值。基于您输入的管脚号预览将显示在框下方。
...
1. 在元件编辑器中，打开 > 元件类型，然后单击“编辑电参数”按钮。
2. 在“元件信息”对话框中，单击“属性”选项卡。
3. 单击“[浏览属性库](#8-9)”可搜索属性。另请参阅“[浏览属性库](#8-9)”。
...
1. 单击[浏览属性库](#8-9)按钮打开[浏览属性库对话框](/logic/guide/24_zh.md#30)。
...
浏览按钮打开[浏览特殊符号对话框](/layout/guide/Dialogs/47_zh.md#4)。
...
3. 从库下拉列表框中选择一个库位置。
   ...
   要更改关联封装的名称，请从“封装名称”多列列表框的“[CAE 封装](#7)”列中选择封装，然后单击“编辑”。
...
3. 单击“编辑电参数”按钮。将显示鼠标“元件信息 - 新连接器”对话框。
...
1. 在项目框中键入上的通配符或表达式来过滤连接器，然后单击应用。
2. 从列表中选择一个连接器。
...
1. 在元件编辑器中，单击“打开”按钮。
2. 在[选择编辑项目类型对话框](/logic/guide/24_zh.md#124)中，选择“管脚封装”，然后单击“确定”。显示管脚封装 浏览对话框。
