...
2. 在[选择编辑项目类型对话框](/logic/guide/24_zh.md#124)中，单击**接地**，然后单击**确定**。
...
6. 要过滤符号，请在项目框中键入上的通配符或表达式，然后单击应用。
...
5. 在“特殊符号”列中，单击新建文本框右侧的按钮。将出现鼠标“浏览特殊符号”对话框。
6. 要过滤符号，请在项目框中键入上的通配符或表达式，然后单击应用。
7. 选择符号封装。
8. 单击“确定”。
...
5. 在“特殊符号”列中，单击新建文本框右侧的按钮。此时将出现上的“浏览特殊符号”对话框。

6. 要过滤符号，请在“项目”框中键入上的“通配符或表达式”，然后单击“应用”。
...
8. 单击“编辑 > [CAE 封装](/logic/guide/7_zh.md#7)编辑器菜单项，或在工具栏上单击“[CAE 封装](/logic/guide/7_zh.md#7)编辑器”按钮。将出现“选择管脚封装”对话框。
...
1. 执行以下操作之一：
   ...
   - 复制现有的特殊符号
     ...
     b. 要过滤符号，请在“筛选条件”框中键入上的通配符或表达式，然后单击“应用”。另请参阅特殊符号命名约定。

     c. 单击“复制”。将显示“将 [CAE 封装](/logic/guide/7_zh.md#7)保存到库”对话框。

      >    [!TIP]
      >
      >    如果“库”列表设置为“所有库”，则无法复制。（库名称列在 [CAE 封装](/logic/guide/7_zh.md#7)列表中的项目之前。）双击符号进入库，然后单击“复制”。
    ...
    - 修改现有的特殊符号
      ...
      b. 要过滤符号，请在项目框中键入上的通配符或表达式，然后单击应用。
      ...
      > [!TIP]
      >
      > 如果“库”列表设置为“所有库”，则“编辑”不可用。（库名称列在 [CAE 封装](/logic/guide/7_zh.md#7)列表中的项目之前。）双击符号进入库，然后单击“编辑”。
   
      e. 最小化[库管理器对话框](/layout/guide/Dialogs/51_zh.md#8)或将其移到一侧。
...
1. 单击工具 > 从库更新菜单项。
2. 在“从库更新”对话框的“模式”区域中，选择“[从库更新设计](/layout/guide/7_zh.md#8)”。
