...
3. 要更改可用颜色，请点击“调色板”。“调色板”会打开“颜色”对话框，您可以在其中指定新颜色或自定义“选定颜色”区域中显示的颜色。
   ...
   > [!TIP]
   >
   > 点击“默认调色板”可恢复“选定颜色”区域中的默认颜色设置。有关[更改调色板](/layout/guide/5_zh.md#2)的更多信息，请参阅 Microsoft Windows 帮助。
...
6. 要[将颜色分配保存到文件](/layout/guide/5_zh.md#8)，请点击“保存”，然后在“保存配置”对话框中键入配置名称。
