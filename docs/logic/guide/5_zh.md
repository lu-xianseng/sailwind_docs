...
2. 在元件编辑器中，单击编辑 > [CAE 封装](/logic/guide/7_zh.md#7)编辑器菜单项。
3. 在 [CAE 封装](/logic/guide/7_zh.md#7)编辑器中，单击工具 > 选项菜单项。
...
要在元件编辑器中设置原点，请从菜单中选择鼠标“设置/设置原点”。将光标定位到您想要的新原点位置，然后单击。
...
6. 要[将颜色分配保存到文件](/layout/guide/5_zh.md#8)，请单击“保存”，然后在“保存配置”对话框中键入配置名称。
