...
有关[创建 PCB 封装](/layout/tutorial/2_zh.md#2)的信息，请参阅 SailWind Layout指南中的“[创建新封装](/layout/guide/7_zh.md#4)”。
...
4. 要过滤列表，请在筛选条件框中键入上的通配符或表达式，然后单击应用。
...
4. 单击新建按钮。
   ...
   - 封装 — 不可用。当前分配的 PCB 封装将显示。使用 `SailWind Layout` 中的库管理器将 PCB 封装添加到库中。另请参阅 `SailWind Layout` 指南中的“[创建新封装](/layout/guide/7_zh.md#4)”。
   ...
   - 直线 - “新建”和“编辑”不可用。所有 2D 绘图项目（例如，绘图格式和标题栏）都会显示，您只能复制或删除它们。没有专门的库直线编辑器。请使用绘图工具创建或编辑直线并将其保存到库中。
     ...
     >  [!TIP]
     > 
     > 要将新的绘图项目添加到库中，请在上创建并合并 SailWind Logic 中的项目，然后单击鼠标右键，再单击“保存到库”。
...
5. 在列表中选择一个项目并单击“编辑”。
   ...
   - 封装 — 不可用。当前分配的 PCB 封装将出现，您只能复制或删除它。使用 PCB 设计程序中的“库管理器”修改 PCB 封装。请参阅《SailWind 布局指南》中的“[编辑库封装](/layout/guide/7_zh.md#5-2)”。
   ...
   - 线 - 不可用。所有 2D 绘图项目（例如，绘图格式、标题栏等）都会显示，您只能复制或删除它们。没有专门的库线编辑器。使用绘图工具创建或编辑线并将其保存到库中。
     ...
     > [!TIP]
     > 
     > 要将新的绘图项目添加到库中，创建并合并 SailWind Logic 中的项目，然后单击鼠标右键，再单击“保存到库”。
...
操作会影响[库管理器对话框](/layout/guide/Dialogs/51_zh.md#8)中库列表的内容。
...
2. 在[库列表对话框](/layout/guide/Dialogs/51_zh.md#7)中，单击添加。
...
1. 单击主页 > 库菜单项，然后单击管理库列表按钮。
2. 在[库列表对话框](/layout/guide/Dialogs/51_zh.md#7)中，从库列表中选择一个或多个库，然后单击移除。
...
1. 单击主页 > 库菜单项，然后单击管理库列表按钮。
2. 从[库列表对话框](/layout/guide/Dialogs/51_zh.md#7)中的库列表中选择库，然后根据需要单击向上或向下。
...
直到您重新打开该对话框时，[库列表对话框](/layout/guide/Dialogs/51_zh.md#7)中的库只读复选框才会更新。
...
1. 单击主页 > 库菜单项，然后单击管理库列表按钮。
2. 在[库列表对话框](/layout/guide/Dialogs/51_zh.md#7)中，选中[与 SailWind Layout同步](#4-8)复选框。
...
[向多个库项目添加属性](/layout/guide/6_zh.md#7-1) [从库项目中删除属性](/layout/guide/6_zh.md#7-2) [重命名库项目的属性](#5-3)
...
1. 单击主页 > 库菜单项，然后在[库管理器对话框](/layout/guide/Dialogs/51_zh.md#8)中单击[属性管理器](/layout/guide/18_zh.md#9)按钮。
...
5. 双击“新名称”单元格，键入名称，然后单击“[重命名属性](/logic/guide/10_zh.md#18-2)”。
...
使用[库管理器对话框](/layout/guide/Dialogs/51_zh.md#8)以 ASCII 格式导入或[导出库数据](#6-2)。
...
1. 单击主页 > 库菜单项。
2. 在[库管理器对话框](/layout/guide/Dialogs/51_zh.md#8)的库列表中，选择要导出其数据的库。
3. 单击以下任意一项：
...
4. 要过滤列表，请在筛选条件框中键入通配符或表达式，然后单击应用。
...
5. 在[报告管理器对话框](/layout/guide/Dialogs/53_zh.md#5)中，指定要包含在报告中的元件属性。
