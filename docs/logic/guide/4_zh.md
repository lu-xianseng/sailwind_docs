...
2. 如果点击“否”，工作区中将显示一张代表新原理图鼠标空白图页。如果点击“是”，且当前原理图未命名，则会出现“[保存原理图文件](#2)”对话框。
...
1. 在工具栏上，点击**打开**按钮。“文件打开”对话框将显示默认 \\SailWind Projects 文件夹中包含的原理图文件。列表根据“文件类型”设置显示文件。
...
1. 打开您想要归档的原理图。
2. 点击主页 > 归档。
3. 在归档对话框中选择要归档的文件和文件夹。
4. 点击“确定”。

👀‍**结果**

将创建一个归档文件夹，其中包含设计和/或原理图文件、库以及您指定的任何其他文件和文件夹。

如果您选择压缩文件，则 .zip 文件是此文件夹中的唯一文件。

如果您选择生成PDF，则使用原理图名称创建文件并将其放置在归档文件夹中。
