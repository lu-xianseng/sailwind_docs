...
- 点击🖱️视图 > 缩放或工具栏上的缩放按钮进入缩放模式。
  - 要放大，请将光标放在所需的视图中心，然后点击🖱️鼠标左键。
  - 要缩小，请将光标放在所需的视图中心，然后点击🖱️鼠标右键。
  - 要定义特定的视图区域，请将光标放在所需的视图中心，点击🖱️并拖动以定义范围，然后释放。
- 点击🖱️视图 > 重画或工具栏上的刷新按钮以重画当前视图。
- 点击🖱️“**查看 > 图页，或点击🖱️工具栏上的“图页**”按钮以显示整个图页。
- 点击🖱️视图 > 范围来调整视图大小以显示设计中的所有对象。
- 使用滚动条平移视图。
...
- 要平移，请点击🖱️鼠标中键。视图以光标为中心。
- 要放大，请点击🖱️并按住鼠标中键。沿对角线向上拖动光标。要调整边界框，请移动鼠标。松开鼠标中键后，边界框内的区域将显示出来。
- 要缩小，请点击🖱️并按住鼠标中键。沿对角线向下拖动光标。这将绘制一个内框，代表当前视图。移动光标可以调整外框，代表新视图。外框相对于内框的相对大小决定了视图缩小的程度。松开鼠标中键即可完成缩小操作。
- 要查看整个设计，请点击🖱️并按住鼠标中键，水平拖动光标，然后松开。
...
3. 在“保存视图”对话框中，点击🖱️“**捕获**”。
4. 在“捕获新视图”对话框中，输入⌨️视图的新名称，然后点击🖱️“**确定**”。新视图名称会列在“视图名称”列表中。
...
1. 点击🖱️**视图 > 保存视图**。
2. 从视图名称列表中选择一个名称，然后点击🖱️应用以将先前选择的视图应用到工作区。

  > [!TIP]
  >
  > 应用视图时，上一个视图会自动保存。点击🖱️“**视图 > “ 上一个视图**”即可恢复该视图。
3. 从视图名称列表中选择一个名称，然后点击🖱️删除将其从视图名称列表中删除。
...
>  [!INFO]
>
> 要打开项目资源管理器，请点击🖱️项目资源管理器按钮。

您可以配置项目资源管理器，以便您可以点击🖱️列出的对象在工作区中选择它，或者选择它并放大到它。

🏃‍♂️‍**步骤**

1. 在项目资源管理器中**右键** > 点击🖱️“**允许选择**”。

   复选标记表示该功能已启用。

2. 如果要缩放至所选对象，请点击🖱️“**缩放至所选内容**”。
...
1. 在“输出”窗口中点击🖱️鼠标右键，然后从“筛选条件”中点击🖱️以下命令之一：
...
1. **右键**点击🖱️“**查找**”。
2. 在“查找”对话框中，键入⌨️要在对话框中查找的文本并完成任何其他对话框选项。
3. 点击🖱️“**下一步**”。标签页会滚动到该单词出现的位置，并高亮显示该单词。
...
要查看报告，请点击🖱️链接。报告将替换会话日志，成为“状态”选项卡中的活动页面。

您可以打印显示的报告。

🏃‍♂️‍**步骤**

1. **右键**点击🖱️显示的报告，然后点击🖱️“**打印**”。

   > [!TIP]
   >  或者，在“状态”选项卡工具栏上，点击🖱️“**打印**”按钮。
...
在状态工具栏上，点击🖱️“**记录到文件**”按钮以保存会话日志以供将来参考。
...
> [!TIP]
对话框操作会被记录为结果而非操作，因此在回放时，您不会在回放过程中看到对话框。因此，您无法创建在打开对话框时停止的宏；它必须遵循某些结果或操作。例如，您可以创建一个宏，选择“主页 > “ 打开”，选择一个文件，然后选择“确定”。该宏在回放时会打开一个文件。
...
1. 在主工具栏上，点击🖱️“**输出窗口**”按钮。
2. 在“宏”选项卡上，点击🖱️“**新建**”按钮。新建的宏将被命名为“宏#”，其中“#”是数字序列，例如“宏 1”或“宏 2”。
3. 如果需要，请点击🖱️**压缩鼠标移动”和/或“相对鼠标移动**按钮。有关更多信息，请参阅“记录鼠标移动”。
4. 在“宏”选项卡工具栏上，点击🖱️“**录制**”按钮。
5. 执行要包含在宏中的击键、命令和鼠标点击🖱️。
6. 在“宏”选项卡工具栏上，点击🖱️“**停止**”按钮。或者，您也可以编写宏脚本，而不是录制鼠标操作。
...
1. 在主工具栏上，点击🖱️“**输出窗口**”按钮；然后在“输出”窗口中，点击🖱️“**宏**”选项卡。
2. 点击🖱️“**打开**”按钮，或者在“打开文件”对话框中选择宏文件，然后点击🖱️“**打开**”。
...
点击🖱️“**宏**”选项卡的“打开的宏列表”区域（左侧窗格）中的宏可在打开的宏之间切换。
...
1. 选择要复制或剪切的文本。
2. 在“宏”选项卡工具栏上，点击🖱️“**复制**”或“剪切”按钮。
3. 将鼠标放在要放置复制文本的插入点处。
4. 在“宏”选项卡工具栏上，点击🖱️“**粘贴**”按钮。

   您将看到您的选择已粘贴到插入点的输出窗口。

   或者，**右键**点击🖱️“**输出**”窗口，然后点击🖱️“**复制**”、“剪切”或“粘贴”。
...
1. 点击🖱️“**保存**”按钮。
2. 在标准 Windows“另存为”对话框中，输入⌨️文件名（如果需要），然后点击🖱️“**保存**”。
...
1. 在“宏”选项卡上，点击🖱️“**打开**”按钮并打开一个宏 (.mcr) 文件。
   您可以通过点击🖱️“**工具**”>“宏”，然后从列表中选择所需的宏来查找最近的宏。
2. 在“宏”选项卡的工具栏上，点击🖱️“**运行**”按钮。
或者，**右键**点击🖱️“**宏**”选项卡，然后点击🖱️“**运行**”。
...
1. 在“宏”选项卡工具栏上，点击🖱️“**暂停**”按钮可随时暂停正在播放的宏。
2. 点击🖱️“**播放**”按钮继续播放宏。
...
在“宏”选项卡上**右键** > 点击🖱️“**停止**”，或者在“宏”选项卡工具栏上点击🖱️“**停止**”按钮以停止播放宏。

宏一旦停止，就无法恢复播放。点击🖱️“**运行**”后，宏将从头开始播放。
...
2. 在“宏”选项卡中**右键** > 点击🖱️“**切换断点**”，或者在“宏”选项卡工具栏上点击🖱️“**切换断点**”按钮。
...
在“宏”选项卡中**右键** > 点击🖱️“**步过**”，或在“宏”选项卡工具栏上点击🖱️“**步过**”按钮
...
在“宏”选项卡中**右键** > 点击🖱️“**步入**”，或者在“宏”选项卡工具栏上点击🖱️“**步入**”按钮。
...
在“宏”选项卡中**右键** > 点击🖱️“**步进到光标**”，或者点击🖱️“**宏**”选项卡工具栏上的“步进到光标”按钮。
...
在“宏”选项卡中**右键** > 点击🖱️“**跳出**”，或者在“宏”选项卡工具栏上点击🖱️“**跳出**”按钮。
...
在“宏”选项卡中**右键** > 点击🖱️“**运行**”，或者在“宏”选项卡工具栏上点击🖱️“**运行**”按钮。
...
点击🖱️“**宏**”选项卡的编辑区域并按 F1 获取有关该术语和示例脚本的信息。
...
2. 在库配置对话框中，按如下方式添加并连接到目标数据源：
   ...
   c. 点击🖱️更新以使新添加的数据源处于活动状态并在 ODBC DSN 列表中可用。
...
2. 在 CIS 选项卡中，在左侧选择一个表，在右侧查看其元件信息。

3. 使用筛选条件查找元件，然后点击🖱️“**搜索**”以激活筛选条件。系统将显示符合搜索筛选条件设置的元件。
...
5. 向设计中添加一个元件，如下所示：
   ...
   b. 点击🖱️原理图以放置元件；另一个实例会自动附加到光标处。

   c. 添加完元件后，按 Esc 键。

6. 在设计中选择元件，**右键** > 点击🖱️“**属性**”。在属性列表中，您可以看到通过“库配置”对话框中的“传输到设计”功能添加的属性。
...
2. 在 CIS 选项卡工具栏上，点击🖱️“**部分...**”按钮以激活比较。
...
3. 在“元件属性信息”区域中检查搜索结果，其中错误以红色突出显示。您还可以：
   ...
   - 点击🖱️表中的任何项目，然后在“比较结果”区域中查看设计和 CIS 中分配的相应属性值，其中差异以红色突出显示。

4. 通过以下任一方式从 CIS 更新不一致的原理图元件属性，这仅对发现“属性不相等”错误的元件有效。

   - 点击🖱️“**全部更新**”可从 CIS 中更新所有不一致的元件属性。
   - 在表中选择一个或多个项目，然后点击🖱️“**更新所选**”可仅更新选定元件的不一致属性。使用 Ctrl 键可进行多项选择。
   - 更新“比较结果”区域中特定元件的属性，有两个可用选项：
     - 更新选定属性：**右键**点击🖱️属性单元格，然后点击🖱️“**从 CIS 更新选定属性**” 
     - 更新所有属性：**右键** > 点击🖱️“**从 CIS 更新选定元件**”
