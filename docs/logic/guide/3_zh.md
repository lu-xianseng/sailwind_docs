...
>  [!INFO]
>
> 要打开[项目资源管理器](/layout/guide/2_zh.md#12)，请单击[项目资源管理器](/layout/guide/2_zh.md#12)按钮。

您可以配置[项目资源管理器](/layout/guide/2_zh.md#12)，以便您可以单击列出的对象在工作区中选择它，或者选择它并放大到它。

🏃‍♂️‍**步骤**

1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中**右键**单击，然后单击“允许选择”菜单项。
