...
- 点击视图 > 缩放或工具栏上的缩放按钮进入缩放模式。
  - 要放大，请将光标放在所需的视图中心，然后点击鼠标左键。
  - 要缩小，请将光标放在所需的视图中心，然后点击鼠标右键。
  - 要定义特定的视图区域，请将光标放在所需的视图中心，点击并拖动以定义范围，然后释放。
- 点击视图 > 重画或工具栏上的刷新按钮以重画当前视图。
- 点击“查看 > 图页，或点击工具栏上的“图页”按钮以显示整个图页。
- 点击视图 > 范围来调整视图大小以显示设计中的所有对象。
- 使用滚动条平移视图。
...
- 要查看整个设计，请点击并按住鼠标中键，水平拖动光标，然后松开。
...
3. 在“保存视图”对话框中，点击“捕获”。
4. 在“捕获新视图”对话框中，输入视图的新名称，然后点击“确定”。新视图名称会列在“视图名称”列表中。
...
1. 点击**视图 > 保存视图**。
2. 从视图名称列表中选择一个名称，然后点击应用以将先前选择的视图应用到工作区。

  > [!TIP]
  >
  > 应用视图时，上一个视图会自动保存。点击“视图 > “ 上一个视图”菜单项即可恢复该视图。
3. 从视图名称列表中选择一个名称，然后点击删除将其从视图名称列表中删除。

## 项目浏览器 \{#2}

[项目资源管理器](/layout/guide/2_zh.md#12)以层次结构列出设计中的对象。更新设计时，层次结构也会自动更新。
...
>  [!INFO]
>
> 要打开[项目资源管理器](/layout/guide/2_zh.md#12)，请点击[项目资源管理器](/layout/guide/2_zh.md#12)按钮。

您可以配置[项目资源管理器](/layout/guide/2_zh.md#12)，以便您可以点击列出的对象在工作区中选择它，或者选择它并放大到它。

🏃‍♂️‍**步骤**

1. 在[项目资源管理器](/layout/guide/2_zh.md#12)中**右键**点击，然后点击“允许选择”。
...
1. 在“输出”窗口中点击鼠标右键，然后从“筛选条件”中点击以下命令之一：
...
2. 点击“打开”按钮，或者在“打开文件”对话框中选择宏文件，然后点击“打开”。
...
1. 点击“保存”按钮。
2. 在标准 Windows“另存为”对话框中，输入文件名（如果需要），然后点击“保存”。
...
1. 在“宏”选项卡上，点击“打开”按钮并打开一个宏 (.mcr) 文件。
   您可以通过点击“工具”>“宏”，然后从列表中选择所需的宏来查找最近的宏。
...
在“宏”选项卡上点击鼠标右键，然后点击“停止”，或者在“宏”选项卡工具栏上点击“停止”按钮以停止播放宏。
...
2. 在“宏”选项卡中**右键**点击，然后点击“切换断点”，或者在“宏”选项卡工具栏上点击“切换断点”按钮。
...
在“宏”选项卡中点击鼠标右键，然后点击“步过”，或在“宏”选项卡工具栏上点击“步过”按钮
...
在“宏”选项卡中点击鼠标右键，然后点击“步入”，或者在“宏”选项卡工具栏上点击“步入”按钮。
...
在“宏”选项卡中点击鼠标右键，然后点击“步进到光标”，或者点击“宏”选项卡工具栏上的“步进到光标”按钮。
...
在“宏”选项卡中点击鼠标右键，然后点击“跳出”，或者在“宏”选项卡工具栏上点击“跳出”按钮。
...
在“宏”选项卡中点击鼠标右键，然后点击“运行”，或者在“宏”选项卡工具栏上点击“运行”按钮。
...
2. 在库配置对话框中，按如下方式添加并连接到目标数据源：
   ...
   c. 点击更新以使新添加的数据源处于活动状态并在 ODBC DSN 列表中可用。
...
5. 向设计中添加一个元件，如下所示：
   ...
   b. 点击原理图以放置元件；另一个实例会自动附加到光标处。

   c. 添加完元件后，按 Esc 键。

6. 在设计中选择元件，**右键**点击，然后点击“属性”。在属性列表中，您可以看到通过“库配置”对话框中的“传输到设计”功能添加的属性。
...
3. 在“元件属性信息”区域中检查搜索结果，其中错误以红色突出显示。您还可以：
   ...
   - 点击表中的任何项目，然后在“比较结果”区域中查看设计和 CIS 中分配的相应属性值，其中差异以红色突出显示。

4. 通过以下任一方式从 CIS 更新不一致的原理图元件属性，这仅对发现“属性不相等”错误的元件有效。

   - 点击“全部更新”可从 CIS 中更新所有不一致的元件属性。
   - 在表中选择一个或多个项目，然后点击“更新所选”可仅更新选定元件的不一致属性。使用 Ctrl 键可进行多项选择。
   - 更新“比较结果”区域中特定元件的属性，有两个可用选项：
     - 更新选定属性：**右键**点击属性单元格，然后点击“从 CIS 更新选定属性” 
     - 更新所有属性：**右键**点击，然后点击“从 CIS 更新选定元件”
