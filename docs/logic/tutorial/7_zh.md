...
3. 放大 R500 周围区域并双击**R500**。
    ...
    > [!TIP]
    >
    > 如果[选择过滤器](/logic/tutorial/2_zh.md#4-1)设置为选择任意对象而非选择元件，双击元件将打开[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)，双击名称标签将打开参考标识符标签属性对话框。

4. 在参考标识符区域，单击**[重命名元件](/logic/guide/15_zh.md#12)**。
5. 在[重命名元件对话框](/logic/guide/24_zh.md#106)中，输入**C10**，然后单击**确定**。R500 被重命名为 C10。

**[更改元件类型](/logic/guide/15_zh.md#3-2)**

将 R500 元件更新为电容器的下一步是将其更改为电容器。使用[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)将其元件类型更改为电容器。

1. 在[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)中，在元件类型区域，单击**更改类型**。
...
6. 单击**关闭**关闭[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)。
...
在[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)中，属性区域列出了多个名称和值。当前，值名称旁边的值框包含???。
...
2. 单击选择电阻器符号。
3. **右键**单击并单击**属性**。
4. 在[元件属性对话框](/layout/guide/Dialogs/47_zh.md#31)中，双击值名称旁边的???值框并输入**10K**，然后按**Enter**。
...
3. **右键**单击并单击**复制**以复制定义的组。新副本将附着到鼠标上。
