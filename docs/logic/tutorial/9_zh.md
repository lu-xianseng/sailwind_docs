...
1. **文件**菜单 > **报告**
2. 在[报告对话框](/layout/guide/Dialogs/53_zh.md#6)中，选择**网络统计**复选框
...
1. **文件**菜单 > **报告**
2. 在[报告对话框](/layout/guide/Dialogs/53_zh.md#6)中，选择**未使用**复选框
...
9. 点击**确定**
10. 在[报告对话框](/layout/guide/Dialogs/53_zh.md#6)中点击**确定**。BillOfMaterials.ref 文件链接出现在输出窗口中
