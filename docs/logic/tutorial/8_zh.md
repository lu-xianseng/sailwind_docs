# 分配约束教程
为设计分配约束可以轻松控制和验证关键设计区域。约束类型包括间距、布线规则和高速规则，可以分配给网络、层、类（网络集合）、组（管脚对集合）或单个管脚对。您还可以分配一组[默认设计规则](/layout/guide/19_zh.md#5-1)，适用于所有没有特殊规则的物体。
...
1. **设置**菜单 > **层定义**
2. 在[层设置对话框](/layout/guide/Dialogs/51_zh.md#4)中，在电气层区域，点击**修改**
3. 在[修改电气层数对话框](/layout/guide/Dialogs/51_zh.md#23)中，输入**4**
...
1. 在[层设置对话框](/layout/guide/Dialogs/51_zh.md#4)中，从层列表中选择**顶层**
2. 在名称框中输入**主元件面**
...
2. 在平面类型区域，点击**CAM 平面**
3. 点击**分配网络**按钮
4. 在[平面层网络对话框](/layout/guide/Dialogs/52_zh.md#27)中，在所有网络列表中，向下滚动，点击网络 **GND** ，点击**添加**将网络与地平面层关联
5. 点击**确定**
6. 设置布线方向为**任意**
...
2. 在平面类型区域，点击**混合平面**
3. 点击**分配网络**按钮
4. 在[平面层网络对话框](/layout/guide/Dialogs/52_zh.md#27)中，选择网络 **+5V** 和 **+12V** ，点击**添加**将网络与电源平面层关联
5. 点击**确定**
6. 设置布线方向为**任意**
...
1. 在[层设置对话框](/layout/guide/Dialogs/51_zh.md#4)中，点击**厚度**
...
11. 点击**确定**关闭层厚度对话框
12. 点击**确定**关闭[层设置对话框](/layout/guide/Dialogs/51_zh.md#4)
...
[间距规则对话框](/layout/guide/Dialogs/47_zh.md#20)的间距区域包含 PCB 设计数据矩阵。您可以为矩阵中的每个或所有数据类型指定值。
...
**[设置默认布线规则](/router/tutorial/2_zh.md#2)**

为避免在平面层上布线，请从布线规则定义的选定布线层中移除它们。

1. 在[规则对话框](/layout/guide/Dialogs/53_zh.md#10)中，点击**布线**按钮
...
1. 在[规则对话框](/layout/guide/Dialogs/53_zh.md#10)中，点击**网络**按钮
...
7. 点击**确定**完成定义
8. 关闭[网络规则对话框](/layout/guide/Dialogs/51_zh.md#29)

## 设置条件规则 \{#4}
当两个网络之间需要特定间距时（以避免对电路产生不利影响），必须定义条件规则。

1. 在[规则对话框](/layout/guide/Dialogs/53_zh.md#10)中，点击**条件规则**按钮
2. 在源规则对象区域，点击**网络**
3. 选择网络  **+5V** 
4. 在目标规则对象区域，点击**网络**
5. 选择网络  **+12V** 
