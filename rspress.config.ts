...
export default defineConfig({
            ...
            tags: [
                {
                    tag: 'script',
                    attrs: {},
                    children: `document.addEventListener('click',function(e){var a=e.target.closest('a[href*="47.108.69.70:8000/editor"]');if(a){e.preventDefault();window.open(a.href,'repopress_editor')}})`,
                },
            ],
        },
    },
    themeConfig: {
        editLink: {
            docRepoBaseUrl: 'http://47.108.69.70:8000/editor/cb708d91-b571-4a26-8117-ecbd2be042c8/docs',
